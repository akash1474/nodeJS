...
/* eslink-disable */
var stripe = Stripe('pasteThePublicKeyHere');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("https://localhost:3000/bookings/checkkout-session/".concat(tourId));
...
if (userPasswordForm) document.querySelector('.btn--save-password').textContent = 'Updating...';
